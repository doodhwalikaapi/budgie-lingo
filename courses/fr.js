...
module.exports = {
  ...
  lessons: [
    ...
    },
    {
      ...
      vocab: [
        { term: 'Un', meaning: 'One' }, { term: 'Deux', meaning: 'Two' }, { term: 'Trois', meaning: 'Three' },
        { term: 'Quatre', meaning: 'Four' }, { term: 'Cinq', meaning: 'Five' }, { term: 'Six', meaning: 'Six' },
        { term: 'Sept', meaning: 'Seven' }, { term: 'Huit', meaning: 'Eight' }, { term: 'Neuf', meaning: 'Nine' },
    ...
    },
    {
      ...
      vocab: [
        { term: 'Rouge', meaning: 'Red' }, { term: 'Bleu', meaning: 'Blue' }, { term: 'Vert', meaning: 'Green' },
        { term: 'Jaune', meaning: 'Yellow' }, { term: 'Noir', meaning: 'Black' }, { term: 'Blanc', meaning: 'White' }
      ],
      questions: [
    ...
    },
    {
      ...
      vocab: [
        { term: 'La mère', meaning: 'Mother' }, { term: 'Le père', meaning: 'Father' },
        { term: 'Le frère', meaning: 'Brother' }, { term: 'La sœur', meaning: 'Sister' },
        { term: 'Les parents', meaning: 'Parents' }, { term: 'Le fils', meaning: 'Son' }
      ],
      questions: [
    ...
    },
    {
      id: 'fr-5', title: 'Food',
      vocab: [
        { term: 'Le pain', meaning: 'Bread' }, { term: "L'eau", meaning: 'Water' },
        { term: 'Le fromage', meaning: 'Cheese' }, { term: 'La pomme', meaning: 'Apple' },
        { term: 'Le café', meaning: 'Coffee' }, { term: 'La viande', meaning: 'Meat' }
      ],
      questions: [
    ...
    },
    {
      ...
      vocab: [
        { term: 'Comment ça va?', meaning: 'How are you?' }, { term: "Je m'appelle...", meaning: 'My name is...' },
        { term: 'Je ne comprends pas', meaning: "I don't understand" }, { term: 'Excusez-moi', meaning: 'Excuse me' },
        { term: 'Où est...?', meaning: 'Where is...?' }, { term: 'De rien', meaning: "You're welcome" }
      ],
      questions: [
